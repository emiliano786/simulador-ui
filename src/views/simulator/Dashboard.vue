  ...
  <content-tpl>
    ...
    <template #header-right>
      <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-3">
          <div class="relative inline-block w-10 h-5">
            ...
            <label
              ...
              class="block overflow-hidden h-5 rounded-full bg-gray-300 dark:bg-slate-700 peer-checked:bg-[#10b981] cursor-pointer"
            ></label>
          </div>
          <label
            for="autoRefreshToggle"
        ...
        >
          <svg
            :class="['w-4 h-4 text-gray-500', isLoading ? 'animate-spin' : '']"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
    ...
    <template #main-content>
      <div class="max-w-7xl mx-auto space-y-6">
          ...
          >
            <div class="flex items-center justify-between mb-2">
              <span
                ...
                class="text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-full"
              >
                {{ stat.label }}
              </span>
              <span
                v-if="stat.showTrend && stat.trend !== 0"
            ...
            <p v-if="stat.subtitle" class="text-[10px] text-gray-400 mt-1">
              {{ stat.subtitle }}
            </p>
          </div>
        </div>
        ...
        <!-- Process Stats Grid -->
        <div
          class="bg-white dark:bg-[#111827] rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm overflow-hidden"
        >
          <div
          ...
          >
            <div class="flex items-center gap-3">
              <div
                class="w-2 h-2 rounded-full bg-[#8b5cf6] animate-pulse"
              ></div>
              <h2
          ...
          <div class="p-6">
            <div v-if="processStats.length === 0" class="text-center py-12">
              ...
              <p class="text-sm text-gray-400 dark:text-gray-500">
                Sin datos de procesos para hoy
              </p>
            </div>
            ...
            >
              ...
              >
                <div class="flex items-center justify-between mb-3">
                  ...
                  <span
                    :class="getSuccessRateClass(proc.success_rate)"
                ...
                <!-- Mini progress bar -->
                <div
                  class="h-1.5 bg-gray-100 dark:bg-slate-800 rounded-full overflow-hidden mb-3"
                >
                  <div
                ...
                <div
                  class="mt-3 pt-3 border-t border-gray-50 dark:border-slate-800 flex items-center justify-between"
                >
                  ...
                  <span
                    ...
                    :class="getLatencyClass(proc.avg_latency_ms)"
                  >
            ...
            <table class="w-full">
              <thead>
                <tr class="bg-gray-50/50 dark:bg-slate-900/50">
                  <th
                    class="px-6 py-3 text-left text-[10px] font-bold text-gray-400 uppercase tracking-wider"
                  >
                    UUID
                  </th>
                  <th
                  ...
                  <th
                    class="px-6 py-3 text-center text-[10px] font-bold text-gray-400 uppercase tracking-wider"
                  >
                    Acción
                  </th>
                </tr>
                ...
                >
                  ...
                  <td class="px-6 py-4">
                    <span
                      ...
                      :class="getLatencyClass(tx.total_latency_ms)"
                    >
                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center gap-1">
                      <span
                        v-for="(proc, idx) in parseRoute(tx.route_executed)"
                        :key="idx"
                  ...
                  <td class="px-6 py-4 text-center">
                    <button
                      @click="openTransactionDetail(tx.uuid)"
        ...
        <Teleport to="body">
          <transition name="fade">
            ...
            >
              <div
                class="bg-white dark:bg-[#111827] rounded-2xl border border-gray-100 dark:border-slate-800 shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden animate-fade-in"
              >
                <!-- Modal Header -->
                <div
                  class="p-6 border-b border-gray-100 dark:border-slate-800 flex justify-between items-start"
                >
                  <div>
                    ...
                    <p class="font-mono text-xs text-gray-400 mt-1">
                      {{ selectedTransaction.summary.uuid }}
                    </p>
                  </div>
                  <button
                ...
                <div class="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                  ...
                  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div
                      class="p-4 rounded-xl bg-gray-50 dark:bg-slate-900/50 border border-gray-100 dark:border-slate-800"
                    >
                      <p
                      ...
                      <span
                        ...
                        "
                        class="text-xs font-bold uppercase tracking-wider px-2 py-1 rounded-full"
                      >
                        {{ selectedTransaction.summary.status }}
                      </span>
                    </div>
                    ...
                    >
                      ...
                      <p
                        ...
                        :class="
                          selectedTransaction.summary.response_code === '00'
                            ? 'text-green-500'
                            : 'text-red-500'
                        "
                      >
                    ...
                    >
                      ...
                      >
                        {{ selectedTransaction.summary.total_latency_ms }}
                    ...
                    >
                      ...
                      <p
                        class="text-xl font-black text-gray-900 dark:text-white"
                      >
                        {{ selectedTransaction.summary.process_count }}
                      </p>
                    </div>
                  </div>
                  ...
                  <!-- Process Timeline -->
                  <h4
                    class="text-xs font-bold text-gray-800 dark:text-gray-200 uppercase tracking-wider mb-4"
                  >
                  ...
                  <div class="space-y-3">
                    <div
                      v-for="(proc, idx) in selectedTransaction.processes"
                      :key="proc.process"
                      class="relative pl-8"
                    >
                      <!-- Timeline connector -->
                      <div
                        v-if="idx < selectedTransaction.processes.length - 1"
                        class="absolute left-3 top-8 w-0.5 h-full bg-gray-200 dark:bg-slate-700"
                      ></div>

                      <!-- Timeline dot -->
                      <div
                        :class="getProcessDotClass(proc.status)"
                        class="absolute left-1 top-2 w-5 h-5 rounded-full flex items-center justify-center"
                      >
                        <svg
                          v-if="proc.status === 'SUCCESS'"
                      ...
                      <!-- Process card -->
                      <div
                        class="rounded-xl border border-gray-100 dark:border-slate-800 p-4 hover:border-purple-200 dark:hover:border-purple-900/50 transition-colors"
                      >
                        <div class="flex items-center justify-between mb-2">
                          <span
                          ...
                          <div class="flex items-center gap-3">
                            <span
                              :class="getStatusBadgeClass(proc.status)"
                            ...
                            <span
                              class="font-mono text-xs font-bold"
                              :class="getLatencyClass(proc.latency_ms)"
                            >
                              {{ proc.latency_ms }} ms
                            </span>
                          </div>
                        ...
                        <div
                          v-if="proc.code || proc.message"
                          class="flex items-center gap-3 text-xs text-gray-500 dark:text-gray-400"
                        >
                          <span v-if="proc.code" class="font-mono font-bold"
                            >Code: {{ proc.code }}</span
                          >
                        ...
                        <div
                          v-if="proc.rule"
                          class="mt-2 px-2 py-1 rounded bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-xs font-medium"
                        >
                          Rule: {{ proc.rule }}
                        </div>
                        ...
                        <!-- Dynamic data fields -->
                        <div
                          v-if="Object.keys(proc.data || {}).length > 0"
                          class="mt-3 pt-3 border-t border-gray-50 dark:border-slate-800"
                        >
                          <p
                            class="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2"
                          >
                            Datos adicionales
                          </p>
                          <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                            <div
                              v-for="(value, key) in proc.data"
                              :key="key"
                              class="text-xs"
                            >
                              <span class="text-gray-400">{{ key }}:</span>
                              <span
                                class="font-mono text-gray-600 dark:text-gray-300 ml-1"
                                >{{ value }}</span
                              >
                            </div>
                          </div>
